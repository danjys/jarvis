...
if platform.system() == 'Darwin':
    ...
    detector = cv2.CascadeClassifier('engine\\auth\\haarcascade_frontalface_default.xml') # WINDOWS
else:
    print("This is another OS")
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        if platform.system() == 'Darwin':
            ...
            cv2.imwrite("engine\\auth\\samples\\face." + str(face_id) + '.' + str(count) + ".jpg", converted_image[y:y+h,x:x+w]) # WINDOWS
        else:
            print("This is another OS")
