...
def AuthenticateFace():
    ...
    if platform.system() == 'Darwin':
        ...
        cascadePath = "engine\\auth\\haarcascade_frontalface_default.xml"# WINDOWS
    else:
    ...
    names = ['', 'Danjy']  # names, leave first empty bcz counter starts from 0
    ...
    if platform.system() == 'Darwin':
        ...
        print("This is another OS")  # cv2.CAP_DSHOW to remove warning
